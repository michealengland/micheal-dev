...
Before going too far, let's talk about what destructuring is. Destructuring is the process of taking data and extracting the data in simpler pieces such as variables.
