...
1. I've really enjoyed working on React-based apps and building components
...
So far, 2021 is off to a good start. I recently overhauled [micheal.dev](https://micheal.dev) to have a better platform to showcase my knowledge and experiences. Next, I turbo-charged my [Github profile](https://github.com/michealengland) with some of details about my side projects that I'm working on.
